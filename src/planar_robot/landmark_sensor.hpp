...
namespace planar_robot {
    ...
    public:
        ...
        void sense (const typename ObservationModel::builder& model_builder, random_source&,
                    const pose&, Observer) const;
...
template <class ObservationModel, class Observer>
void planar_robot::landmark_sensor
::sense (const typename ObservationModel::builder& model_builder, random_source& random,
         const pose& state, Observer observer) const {
